...
public class C02_xpath {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //driver.findElement(By.xpath("//button[@onclick='addElement()']")).click();  // boyle olur
        //driver.findElement(By.xpath("//button[text()='Add Element']")).click();    // boyle de olur
        driver.findElement(By.xpath("//*[text()='Add Element']")).click();           //  boyle de olurr

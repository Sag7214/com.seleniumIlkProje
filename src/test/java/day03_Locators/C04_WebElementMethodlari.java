...
public class C04_WebElementMethodlari {
    ...
    2-sonra aram kutusunun input oldugunu test edin
...
//    2-sonra arama kutusunun input oldugunu test edin
        ...
        webElementIsmi.getTagName() => daha once locate ettigimiz bir webelement in tagname'ni dondurur

        webElementIsmi.getAttribute(attributeIsmi) => daha once locate ettigimiz bir webelement in
